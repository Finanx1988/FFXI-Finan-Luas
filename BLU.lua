...
function job_setup()
	...
	state.WeaponSet = M{['description']='Weapon Set', 'Magic', 'Physical'}
...
function init_gear_sets()
	...
	sets.Physical = {main="Naegling", sub="Sequence"}
    sets.Physical.Acc = {main="Naegling", sub="Sequence"}
	sets.Magic = {main="Naegling", sub="Kaja Rod"}
	sets.Magic.Acc = {main="Naegling", sub="Kaja Rod"}
