...
function user_setup()
	...
	send_command('wait 3; input //get Dojikiri Yasutsuna Case')
	send_command('wait 3; input //get Norifusa Case')
	send_command('wait 3; input //get Soboro Sukehiro Case')
	send_command('wait 3; input //get Flam. Zucchetto +2 Case')
	send_command('wait 3; input //get Valorous Mask Case')
	send_command('wait 3; input //get Ken. Samue Case')
	send_command('wait 3; input //get Flamma Korazin +2 Case')
	send_command('wait 3; input //get Founder\'s Breastplate Case')
	send_command('wait 3; input //get Wakido Kote +3 Case')
	send_command('wait 3; input //get Flam. Manopolas +2 Case')
	send_command('wait 3; input //get Valorous Mitts Case')
	send_command('wait 3; input //get Founder\'s Gauntlets Case')
	send_command('wait 3; input //get Hiza. Hizayoroi +2 Case')
	send_command('wait 3; input //get Ken. Hakama Case')
	send_command('wait 3; input //get Flam. Gambieras +2 Case')
	send_command('wait 3; input //get Valorous Greaves Case')
	send_command('wait 3; input //get Founder\'s Greaves Case')
	send_command('wait 3; input //get Moonbeam Nodowa Case')
	send_command('wait 3; input //get Smertrios\'s Mantle Case all')
	send_command('wait 3; input //get Thrud Earring Case')
	send_command('wait 3; input //get Flamma Ring Case')
...
function user_unload()
	...
	send_command('input //put Norifusa Case')
	send_command('input //put Soboro Sukehiro Case')
	send_command('input //put Flam. Zucchetto +2 Case')
	send_command('input //put Valorous Mask Case')
	send_command('input //put Ken. Samue Case')
	send_command('input //put Flamma Korazin +2 Case')
	send_command('input //put Founder\'s Breastplate Case')
	send_command('input //put Wakido Kote +3 Case')
	send_command('input //put Flam. Manopolas +2 Case')
	send_command('input //put Valorous Mitts Case')
	send_command('input //put Founder\'s Gauntlets Case')
	send_command('input //put Hiza. Hizayoroi +2 Case')
	send_command('input //put Ken. Hakama Case')
	send_command('input //put Flam. Gambieras +2 Case')
	send_command('input //put Valorous Greaves Case')
	send_command('input //put Founder\'s Greaves Case')
	send_command('input //put Moonbeam Nodowa Case')
	send_command('input //put Smertrios\'s Mantle Case all')
	send_command('input //put Thrud Earring Case')
	send_command('input //put Flamma Ring Case')
