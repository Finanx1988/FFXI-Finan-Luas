...
--              	[ Windows + ` ]     Toggle use of Luzaf Ring.
--
--
--	Weapons:		[ Windows: + W ]		Cycle Weaponsets
--					[ Windows + R ]			Cycle Rangesets
--
--
--	Weaponskills:	[ CTRL + Numpad1 ]	Leaden Salute
...
--					[ Windows + Numpad7 ]	Trump Card Case
--
--
...
function user_setup()
	...
	send_command('bind @numpad7 input /item "Trump Card Case" <me>')
		
	--Ranged Scripts (Tags CTRL + Numpad0 as ranged attack)

	send_command('bind ^numpad0 input /ra <t>')

	--Warp scripts (this allows the ring to stay in your satchel fulltime)
    ...
    send_command('bind ^numpad. input //get Chr. Bul. Pouch satchel; wait 1; input /equip waist "Chr. Bul. Pouch"; wait 15; input /item "Chr. Bul. Pouch" <me>; wait 3; input /equip waist; input //put Chr. Bul. Pouch satchel')
    send_command('bind @numpad. input //get Liv. Bul. Pouch satchel; wait 1; input /equip waist "Liv. Bul. Pouch"; wait 15; input /item "Liv. Bul. Pouch" <me>; wait 3; input /equip waist; input //put Liv. Bul. Pouch satchel')
	send_command('bind !numpad. input //get Dev. Bul. Pouch satchel; wait 1; input /equip waist "Dev. Bul. Pouch"; wait 15; input /item "Dev. Bul. Pouch" <me>; wait 3; input /equip waist; input //put Dev. Bul. Pouch satchel')
	
	--Gear Retrieval Commands
	
	send_command('wait 3; input //get Chrono Bullet satchel all')
	send_command('wait 3; input //get Devastating Bullet satchel all')
	send_command('wait 3; input //get Living Bullet satchel all')
	send_command('wait 3; input //get Trump Card satchel all')
...
function init_gear_sets()
    ...
    sets.Rostam = {main={ name="Rostam", augments={'Path: C',}}, sub="Blurred Knife +1"}
    sets.Rostam.Acc = {main={ name="Rostam", augments={'Path: C',}}, sub={ name="Demers. Degen +1", augments={'Path: A',}},}
	sets.Rostam.RAcc = {main={ name="Rostam", augments={'Path: C',}}, sub={ name="Kustawi +1", augments={'Path: A',}},}
	sets.Naegling = {main="Naegling", sub="Blurred Knife +1"}
    sets.Naegling.Acc = {main="Naegling", sub={ name="Demers. Degen +1", augments={'Path: A',}},}
