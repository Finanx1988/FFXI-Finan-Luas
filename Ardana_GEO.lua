...
--
--  WS:         [ CTRL+Numpad1 ]    Black Halo
--	            [ CTRL+Numpad2 ]    Hexa Strike
--	            [ CTRL+Numpad3 ]    Realmrazer
--	            [ CTRL+Numpad4 ]    Exudation
--	            [ CTRL+Numpad5 ]    Flash Nova
--
--
...
function user_setup()
    ...
    send_command('bind ^numpad2 input /ws "Hexa Strike" <t>')
    send_command('bind ^numpad3 input /ws "Realmrazer" <t>')
    send_command('bind ^numpad4 input /ws "Exudation" <t>')
