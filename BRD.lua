...
--  Abilities:
--
--  Gear locks: [ Windows+W ]          Toggles Weapon Lock
--				[ Windows+C ]          Toggles CP (Back Lock)
--
--  WS:         
--				[ CTRL+Numpad1 ]    Rudra's Storm
...
function init_gear_sets()
	...
	-- Default Dummy songs (Herb Pastoral / Shining Fantasia / Scop's Operetta / Puppet's Operetta").
	
	sets.midcast.SongDummy = {
		main={ name="Kali", augments={'Mag. Acc.+15','String instrument skill +10','Wind instrument skill +10',}},
		sub="Genmei Shield",
		range="Terpander",
		head={ name="Vanya Hood", augments={'MP+50','"Fast Cast"+10','Haste+2%',}},
