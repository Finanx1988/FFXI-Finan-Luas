...
function user_setup()
	...
	send_command('wait 3; input //get Chapuli Arrow satchel all')
...
function init_gear_sets()
	...
	sets.midcast['Break'] = sets.midcast['Enfeebling Magic'].MACC
	sets.midcast['Bind'] = sets.midcast['Enfeebling Magic'].MACC
	sets.midcast['Sleep'] = sets.midcast['Enfeebling Magic'].MACC
	sets.midcast['Sleep II'] = sets.midcast['Enfeebling Magic'].MACC	
